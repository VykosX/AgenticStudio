...
exports.configSchematics = (0, sdk_1.createConfigSchematics)()
    .field("defaultToolProfile", "select", {
    ...
    .field("informAgentOfAllTools", "boolean", {
    ...
    .field("allowIndividualToolRequests", "boolean", {
    ...
    .field("enableToolAliases", "boolean", {
    ...
    .field("enablePerAppAutomationGuidance", "boolean", {
    ...
    .field("cavemanSkillProfile", "select", {
    ...
    .field("cavemanifyToolResults", "boolean", {
    ...
    .field("allowFullFilesystemAccess", "boolean", {
    ...
    .field("allowAutoExecution", "boolean", {
    ...
    .field("forbiddenCommands", "string", {
    ...
    .field("disableBlacklistCommands", "string", {
    ...
    .field("directoryDeleteConfirmationCount", "numeric", {
    ...
    .field("zstdCompressionLevel", "numeric", {
    ...
    .field("watcherDefaultLimit", "numeric", {
    ...
    .field("compilerPreference", "select", {
    ...
    .field("defaultTimeoutMs", "numeric", {
    ...
    .field("browserAutomationBackend", "select", {
    ...
    .field("camofoxHomeDirectory", "string", {
    ...
    .field("subAgentShowFullCode", "boolean", {
    ...
    .field("subAgentMaxDepth", "numeric", {
    ...
    .field("additionalSearchPaths", "string", {
    ...
    .field("libreHardwareMonitorPath", "string", {
